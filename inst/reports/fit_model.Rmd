...
We estimate times of onset and death for all `nrow(linelist)` reported cases. We further estimate the parameters of the onset-to-death distribution, and the serial interval from `nrow(wiw)` established transmission pairs.
